...
namespace DAL
{
    public class DBConection
    {
        ...
        {
            using (EazyShopEntities m = new EazyShopEntities())
            {
                return m.GetDbSet<T>().ToList();
            }
        }
            ...
            using (EazyShopEntities m = new EazyShopEntities())
            {
                ...
                switch (exAction)
                {
                    ...
                    case ExecuteActions.Update:
                        model.Attach(entity);
                        m.Entry(entity).State = System.Data.Entity.EntityState.Modified;
                        break;
                    case ExecuteActions.Delete:
                        model.Attach(entity);
                        m.Entry(entity).State = System.Data.Entity.EntityState.Deleted;
                        break;
                    default:
                        break;
                }
